(() => {
    ...
    input.addEventListener("input", (function() {
        ...
        const elements = document.querySelectorAll(".recipes__item");
        const filteredElements = Array.from(elements).filter((element => {
            const childElements = element.querySelectorAll(".recipes__link");
    ...
    if (window.location.pathname !== "/index.html") {
        ...
        function showChild(index) {
            ...
            window.location.href = `${window.location.href.split("-")[0]}-${index + 1}`;
        }
        function nextChild() {
